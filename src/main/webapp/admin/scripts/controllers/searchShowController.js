...
angular.module('myticketmonster').controller('SearchShowController', function($scope, $http, $filter, ShowResource , EventResource, VenueResource, PerformanceResource, TicketPriceResource) {
