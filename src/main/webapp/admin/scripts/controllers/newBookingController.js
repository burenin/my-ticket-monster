...
angular.module('myticketmonster').controller('NewBookingController', function ($scope, $location, locationParser, flash, BookingResource , TicketResource, PerformanceResource) {
