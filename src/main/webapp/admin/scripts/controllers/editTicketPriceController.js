...
angular.module('myticketmonster').controller('EditTicketPriceController', function($scope, $routeParams, $location, flash, TicketPriceResource , ShowResource, SectionResource, TicketCategoryResource) {
    var self = this;
