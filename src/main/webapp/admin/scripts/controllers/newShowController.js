...
angular.module('myticketmonster').controller('NewShowController', function ($scope, $location, locationParser, flash, ShowResource , EventResource, VenueResource, PerformanceResource, TicketPriceResource) {
