...
angular.module('myticketmonster').controller('EditBookingController', function($scope, $routeParams, $location, flash, BookingResource , TicketResource, PerformanceResource) {
    var self = this;
