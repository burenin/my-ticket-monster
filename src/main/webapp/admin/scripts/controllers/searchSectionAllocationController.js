...
angular.module('myticketmonster').controller('SearchSectionAllocationController', function($scope, $http, $filter, SectionAllocationResource , PerformanceResource, SectionResource) {
