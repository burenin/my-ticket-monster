...
angular.module('myticketmonster').controller('NewVenueController', function ($scope, $location, locationParser, flash, VenueResource , MediaItemResource, SectionResource) {
