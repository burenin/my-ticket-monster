...
angular.module('myticketmonster').controller('EditSectionAllocationController', function($scope, $routeParams, $location, flash, SectionAllocationResource , PerformanceResource, SectionResource) {
    var self = this;
