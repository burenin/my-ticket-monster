...
angular.module('myticketmonster').controller('EditShowController', function($scope, $routeParams, $location, flash, ShowResource , EventResource, VenueResource, PerformanceResource, TicketPriceResource) {
    var self = this;
