...
angular.module('myticketmonster').controller('NewTicketController', function ($scope, $location, locationParser, flash, TicketResource , TicketCategoryResource, SectionResource) {
