...
angular.module('myticketmonster').controller('EditVenueController', function($scope, $routeParams, $location, flash, VenueResource , MediaItemResource, SectionResource) {
    var self = this;
