...
angular.module('myticketmonster').controller('EditEventController', function($scope, $routeParams, $location, flash, EventResource , MediaItemResource, EventCategoryResource) {
    var self = this;
