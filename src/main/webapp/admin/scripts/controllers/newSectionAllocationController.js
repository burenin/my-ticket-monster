...
angular.module('myticketmonster').controller('NewSectionAllocationController', function ($scope, $location, locationParser, flash, SectionAllocationResource , PerformanceResource, SectionResource) {
